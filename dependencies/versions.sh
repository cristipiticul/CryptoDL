...
SEAL_INCLUDE_DIR="${SEAL_DIR}"/include/SEAL-4.0
...
echo "DEP_LIBS := ${HELIB_DIR}/lib/fhe.a -L${HELIB_DIR}/lib ${SEAL_DIR}/lib/libseal-4.0.a -L${SEAL_DIR}/lib -lntl -lboost_filesystem -lpthread -lboost_system -ljpeg" >> "${MAKEFILE}"
